    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <form method="POST" action="{{ route('roles.update', ['id' => $role->id]) }}" enctype="multipart/form-data" novalidate>
                    @csrf
                    ...
                    <div class="form-group my-2">
                        ...
                        <textarea class="form-control" name="description" id="description" value="{{ $role->description }}" rows="10" cols="50"></textarea>
                    </div>

                    <div class="form-group my-2">
                        @foreach ($permissionList as $permission)
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="permissions[]" id="permissions" value="{{ $permission->id }}" {{$permissionsOfRole->contains($permission->id) ? 'checked' : ''}}/>
